...
public class GeoIPService extends Service {
    ...
    public com.lavasoft.GeoIPServiceSoap getGeoIPServiceSoap() {
        return super.getPort(GeoIPServiceSoap, com.lavasoft.GeoIPServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "GeoIPServiceSoap")
    public com.lavasoft.GeoIPServiceSoap getGeoIPServiceSoap(WebServiceFeature... features) {
        return super.getPort(GeoIPServiceSoap, com.lavasoft.GeoIPServiceSoap.class, features);
    }
    ...
    public com.lavasoft.GeoIPServiceSoap getGeoIPServiceSoap12() {
        return super.getPort(GeoIPServiceSoap12, com.lavasoft.GeoIPServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "GeoIPServiceSoap12")
    public com.lavasoft.GeoIPServiceSoap getGeoIPServiceSoap12(WebServiceFeature... features) {
        return super.getPort(GeoIPServiceSoap12, com.lavasoft.GeoIPServiceSoap.class, features);
    }
    ...
    public com.lavasoft.GeoIPServiceHttpPost getGeoIPServiceHttpPost() {
        return super.getPort(GeoIPServiceHttpPost, com.lavasoft.GeoIPServiceHttpPost.class);
    }
     ...
     */
    @WebEndpoint(name = "GeoIPServiceHttpPost")
    public com.lavasoft.GeoIPServiceHttpPost getGeoIPServiceHttpPost(WebServiceFeature... features) {
        return super.getPort(GeoIPServiceHttpPost, com.lavasoft.GeoIPServiceHttpPost.class, features);
    }
